...
/**
 * USDT (TRC20) webhook endpoint
 * TODO: Integrate with Tron blockchain scanner or payment processor
 */
export async function POST(req: NextRequest) {
  try {
    ...
    // TODO: Verify USDT transaction on Tron blockchain
    // For now, trust the webhook (admin should verify manually via blockchain explorer)
    ...
    console.error("[usdt-webhook] error:", err);
