...
/**
 * Wing webhook endpoint
 * TODO: Implement actual Wing API verification when available
 */
export async function POST(req: NextRequest) {
  try {
    ...
    // TODO: Verify with Wing API using transactionId
    ...
    console.error("[wing-webhook] error:", err);
