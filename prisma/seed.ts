...
async function main() {
  console.log("⚡ Seeding Ty Khai TopUp database...");
  ...
  await prisma.settings.upsert({
    ...
    create: {
      ...
      exchangeRate: 4100,
      supportTelegram: "@Vichet_SAT",
      supportEmail: "support@tykhai.com",
    },
  });

  // --- Admin user ---
  const adminEmail = process.env.ADMIN_EMAIL || "admin@tykhai.tp";
  const adminPassword = process.env.ADMIN_PASSWORD || "tykhai123";
  ...
  const games = [
    {
      ...
      imageUrl: "/games/mlbb.jpg",
      bannerUrl: "/banners/mlbb.jpg",
    ...
    },
    {
      ...
      imageUrl: "/games/freefire.jpg",
      bannerUrl: "/banners/freefire.jpg",
      currencyName: "Diamonds",
      uidLabel: "Player ID",
    ...
    },
    {
      ...
      imageUrl: "/games/pubgm.jpg",
      bannerUrl: "/banners/pubgm.jpg",
      currencyName: "UC",
      uidLabel: "Player ID",
